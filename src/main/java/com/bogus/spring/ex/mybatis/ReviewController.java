package com.bogus.spring.ex.mybatis;
...
import com.bogus.spring.ex.mybatis.bo.ReviewBO;
...
//		int id = Integer.parseInt(request.getParameter("id"));
	...
	public String addReview() {
		// 4, "콤비네이션피자", "염근효", 4.5, "할인도 많이 받고 잘 먹었어요"
//		int count = reviewBO.addReview(4, "콤비네이션피자", "염근효", 4.5, "할인도 많이 받고 잘 먹었어요");
		
		Review review = new Review();
		review.setStoreId(2);
		review.setMenu("뿌링클");
		review.setUserName("염근효");
		review.setPoint(4.0);
